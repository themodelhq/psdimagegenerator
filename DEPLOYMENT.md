...
6. Copy your Render URL: `https://psd-image-generator-api.onrender.com`
...
4. Add **Environment Variables** in Netlify → Site Settings → Environment Variables:
   ...
   ```
   VITE_API_URL=https://psd-image-generator-api.onrender.com
   VITE_APP_ID=<your manus app id>
...
[[redirects]]
  from = "/api/*"
  to = "https://psd-image-generator-api.onrender.com/api/:splat"

[[redirects]]
  from = "/socket.io/*"
  to = "https://psd-image-generator-api.onrender.com/socket.io/:splat"
```
